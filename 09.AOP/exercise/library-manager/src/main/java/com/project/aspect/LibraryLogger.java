...
public class LibraryLogger {
    @AfterThrowing(pointcut = "execution(public * com.project.service.BookService.*(..))", throwing = "a")
    public void checkError(JoinPoint joinPoint, Exception a) {
//check here
    }
    @AfterReturning(pointcut = "execution(public * com.project.service.BookService.*(..))",returning = "books")
